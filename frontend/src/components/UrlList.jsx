    ...
    <section className="rounded-2xl border border-orange-100 bg-white p-5 shadow-sm">
      <div className="mb-4 flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={onRetry}
          className="rounded-lg border border-orange-200 px-3 py-1 text-sm font-medium text-orange-700 transition hover:bg-orange-50"
        >
          Refresh
        </button>
      </div>
      ...
      {!loading && !error && urls.length > 0 && (
        <div className="overflow-x-auto">
          <table className="min-w-full border-separate border-spacing-y-1 text-left text-sm">
            <thead>
              <tr className="border-b border-orange-100 text-slate-600">
            ...
            <tbody>
              {urls.map((url) => {
                ...
                return (
                  <tr key={url.id} className="rounded-lg bg-orange-50/40">
                    ...
                    <td className="rounded-r-lg py-3 pr-2">
                      <button
                        ...
                        className="rounded-md bg-orange-600 px-3 py-1.5 text-xs font-medium text-white transition hover:bg-orange-500"
                      >
